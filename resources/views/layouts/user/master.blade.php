    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <h1 class="mb-4">Selamat Datang di <i class="fa fa-utensils text-primary me-2"></i>OrderKuy</h1>
                <p class="mb-4">OrderKuy adalah aplikasi berbasis website.</p>
                <p class="mb-4">Fungsi dari website ini adalah untuk mempermudah pelanggan dalam memesan makanan
                    ataupun minuman dimanapun dan kapanpun. Dan fungsi lainnya jika berada diresto yang sudah
                    menggunakan aplikasi ini, pelanggan tidak harus memesan ke meja kasir ataupun ditunggu oleh pelayan
                    yang dapat membuat pelanggan jengkel.</p>
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                            ...
                            <div class="ps-4">
                                ...
                                <h6 class="text-uppercase mb-0">Resto</h6>
                            </div>
                        </div>
                    </div>
                </div>
